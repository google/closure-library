...
/**
 * @fileoverview Defines the goog.loader.ModuleInfo class.
 *
 */

goog.provide('goog.loader.ModuleInfo');
 ...
 * @final
 */
goog.loader.ModuleInfo = function(deps, id) {
   ...
   * @type {Array<goog.loader.ModuleLoadCallback>}
   * @private
   */
...
goog.inherits(goog.loader.ModuleInfo, goog.Disposable);
 ...
 * @private
 */
goog.loader.ModuleInfo.prototype.uris_ = null;


/**
 * The constructor to use to instantiate the module object after the module
 * code is loaded. This must be either goog.loader.BaseModule or a subclass of
 * it.
 * @type {Function}
 * @private
 */
goog.loader.ModuleInfo.prototype.moduleConstructor_ = goog.loader.BaseModule;


/**
 * The module object. This will be null until the module is loaded.
 * @type {goog.loader.BaseModule?}
 * @private
 */
goog.loader.ModuleInfo.prototype.module_ = null;
 ...
 */
goog.loader.ModuleInfo.prototype.getDependencies = function() {
  return this.deps_;
};
 ...
 */
goog.loader.ModuleInfo.prototype.getId = function() {
  return this.id_;
};
 ...
 */
goog.loader.ModuleInfo.prototype.setUris = function(uris) {
  this.uris_ = uris;
};
 ...
 */
goog.loader.ModuleInfo.prototype.getUris = function() {
  return this.uris_;
};
 ...
 * @param {Function} constructor The constructor of a goog.loader.BaseModule
 *     subclass.
 */
goog.loader.ModuleInfo.prototype.setModuleConstructor = function(constructor) {
  if (this.moduleConstructor_ === goog.loader.BaseModule) {
 ...
 *     the callback.
 * @return {!goog.loader.ModuleLoadCallback} Reference to the callback
 *     object.
 */
goog.loader.ModuleInfo.prototype.registerEarlyCallback = function(
    fn, opt_handler) {
 ...
 *     object.
 */
goog.loader.ModuleInfo.prototype.registerCallback = function(fn, opt_handler) {
 ...
 *     object.
 */
goog.loader.ModuleInfo.prototype.registerErrback = function(fn, opt_handler) {
...
/**
 * Registers a function that should be called after the module is loaded.
 * @param {Array<goog.loader.ModuleLoadCallback>} callbacks The array to
 *     add the callback to.
 * @param {Function} fn A callback function that takes a single argument which
 *     is the module context.
 * @param {Object=} opt_handler Optional handler under whose scope to execute
 ...
 * @private
 */
goog.loader.ModuleInfo.prototype.registerCallback_ = function(
    callbacks, fn, opt_handler) {
  var callback = new goog.loader.ModuleLoadCallback(fn, opt_handler);
 ...
 */
goog.loader.ModuleInfo.prototype.isLoaded = function() {
  return !!this.module_;
};
...
/**
 * Gets the module.
 * @return {goog.loader.BaseModule?} The module if it has been loaded.
 *     Otherwise, null.
 */
goog.loader.ModuleInfo.prototype.getModule = function() {
  return this.module_;
};
 ...
 *     callbacks.
 */
goog.loader.ModuleInfo.prototype.onLoad = function(contextProvider) {
 ...
 * @param {goog.loader.ModuleManager.FailureType} cause What caused the error.
 */
goog.loader.ModuleInfo.prototype.onError = function(cause) {
 ...
 * @param {Array<goog.loader.ModuleLoadCallback>} callbacks The callbacks
 ...
 * @private
 */
goog.loader.ModuleInfo.prototype.callCallbacks_ = function(callbacks, context) {
  // NOTE(nicksantos):
...
/** @override */
goog.loader.ModuleInfo.prototype.disposeInternal = function() {
  goog.loader.ModuleInfo.superClass_.disposeInternal.call(this);
