...
goog.provide('goog.loader.ModuleLoader');
...
goog.require('goog.loader.AbstractModuleLoader');
 ...
 * @implements {goog.loader.AbstractModuleLoader}
 */
goog.loader.ModuleLoader = function() {
  goog.loader.ModuleLoader.base(this, 'constructor');

  /**
   * Event handler for managing handling events.
   * @type {goog.events.EventHandler<!goog.loader.ModuleLoader>}
   * @private
   */
  this.eventHandler_ = new goog.events.EventHandler(this);

  /**
   * A map from module IDs to goog.loader.ModuleLoader.LoadStatus.
   * @type {!Object<Array<string>, goog.loader.ModuleLoader.LoadStatus>}
   * @private
   */
  this.loadingModulesStatus_ = {};
};
goog.inherits(goog.loader.ModuleLoader, goog.events.EventTarget);
 ...
 * @protected
 */
goog.loader.ModuleLoader.prototype.logger =
    goog.log.getLogger('goog.loader.ModuleLoader');
 ...
 * @private
 */
goog.loader.ModuleLoader.prototype.debugMode_ = false;
 ...
 * @private
 */
goog.loader.ModuleLoader.prototype.sourceUrlInjection_ = false;


/**
 * @return {boolean} Whether sourceURL affects stack traces.
 */
goog.loader.ModuleLoader.supportsSourceUrlStackTraces = function() {
 ...
 */
goog.loader.ModuleLoader.supportsSourceUrlDebugger = function() {
 ...
 */
goog.loader.ModuleLoader.prototype.getDebugMode = function() {
 ...
 */
goog.loader.ModuleLoader.prototype.setDebugMode = function(debugMode) {
 ...
 */
goog.loader.ModuleLoader.prototype.setSourceUrlInjection = function(enabled) {
 ...
 * @private
 */
goog.loader.ModuleLoader.prototype.usingSourceUrlInjection_ = function() {
  return this.sourceUrlInjection_ ||
      (this.getDebugMode() &&
       goog.loader.ModuleLoader.supportsSourceUrlStackTraces());
};


/** @override */
goog.loader.ModuleLoader.prototype.loadModules = function(
    ids, moduleInfoMap, opt_successFn, opt_errorFn, opt_timeoutFn,
    opt_forceReload) {
  var loadStatus = this.loadingModulesStatus_[ids] ||
      new goog.loader.ModuleLoader.LoadStatus();
 ...
 * @private
 */
goog.loader.ModuleLoader.prototype.evaluateCode_ = function(moduleIds) {
  this.dispatchEvent(
      new goog.loader.ModuleLoader.RequestSuccessEvent(moduleIds));
  ...
  this.dispatchEvent(new goog.loader.ModuleLoader.EvaluateCodeEvent(moduleIds));
 ...
 * @private
 */
goog.loader.ModuleLoader.prototype.handleSuccess_ = function(
...
/** @override */
goog.loader.ModuleLoader.prototype.prefetchModule = function(id, moduleInfo) {
  ...
  this.loadingModulesStatus_[[id]] = new goog.loader.ModuleLoader.LoadStatus();
 ...
 * @private
 */
goog.loader.ModuleLoader.prototype.downloadModules_ = function(
    ids, moduleInfoMap) {
  var uris = [];
 ...
 * @private
 */
goog.loader.ModuleLoader.prototype.handleError_ = function(
 ...
 * @private
 */
goog.loader.ModuleLoader.prototype.handleErrorHelper_ = function(
    moduleIds, errorFn, status, opt_error) {
  this.dispatchEvent(
      new goog.loader.ModuleLoader.RequestErrorEvent(moduleIds, opt_error));
...
/** @override */
goog.loader.ModuleLoader.prototype.disposeInternal = function() {
  goog.loader.ModuleLoader.superClass_.disposeInternal.call(this);
 ...
 * @const
 */
goog.loader.ModuleLoader.EventType = {
  /**
   * @const {!goog.events.EventId<
   *     !goog.loader.ModuleLoader.EvaluateCodeEvent>} Called after the code for
  ...
  /**
   * @const {!goog.events.EventId<
   *     !goog.loader.ModuleLoader.RequestSuccessEvent>} Called when the
  ...
  /**
   * @const {!goog.events.EventId<
   *     !goog.loader.ModuleLoader.RequestErrorEvent>} Called when the
 ...
 * @protected
 */
goog.loader.ModuleLoader.EvaluateCodeEvent = function(moduleIds) {
  goog.loader.ModuleLoader.EvaluateCodeEvent.base(
      this, 'constructor', goog.loader.ModuleLoader.EventType.EVALUATE_CODE);
...
goog.inherits(goog.loader.ModuleLoader.EvaluateCodeEvent, goog.events.Event);
 ...
 * @protected
 */
goog.loader.ModuleLoader.RequestSuccessEvent = function(moduleIds) {
  goog.loader.ModuleLoader.RequestSuccessEvent.base(
      this, 'constructor', goog.loader.ModuleLoader.EventType.REQUEST_SUCCESS);
...
goog.inherits(goog.loader.ModuleLoader.RequestSuccessEvent, goog.events.Event);
 ...
 * @protected
 */
goog.loader.ModuleLoader.RequestErrorEvent = function(moduleIds, opt_error) {
  goog.loader.ModuleLoader.RequestErrorEvent.base(
      this, 'constructor', goog.loader.ModuleLoader.EventType.REQUEST_ERROR);
...
goog.inherits(goog.loader.ModuleLoader.RequestErrorEvent, goog.events.Event);
 ...
 * @final
 */
goog.loader.ModuleLoader.LoadStatus = function() {
  /**
   * The request uris.
   * @type {Array<string>}
   */
