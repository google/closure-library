...
goog.provide('goog.loader.ModuleManager');
goog.provide('goog.loader.ModuleManager.CallbackType');
goog.provide('goog.loader.ModuleManager.FailureType');
 ...
 * @struct
 */
goog.loader.ModuleManager = function() {
  goog.loader.ModuleManager.base(this, 'constructor');

  /**
   * A mapping from module id to ModuleInfo object.
   * @private {Object<string, !goog.loader.ModuleInfo>}
   */
  this.moduleInfoMap_ = {};
   ...
   * callback type.
   * @type {Object<goog.loader.ModuleManager.CallbackType, Array<Function>>}
   * @private
   */
  this.callbackMap_ = {};
   ...
   *
   * @type {goog.loader.ModuleInfo}
   * @private
   */
  this.baseModuleInfo_ = new goog.loader.ModuleInfo([], '');
   ...
   */
  this.logger_ = goog.log.getLogger('goog.loader.ModuleManager');
   ...
   * @private {goog.loader.AbstractModuleLoader}
   */
  this.loader_ = null;
...
goog.inherits(goog.loader.ModuleManager, goog.Disposable);
goog.addSingletonGetter(goog.loader.ModuleManager);
...
* @enum {string}
*/
goog.loader.ModuleManager.CallbackType = {
  /**
 ...
 * @type {number}
 */
goog.loader.ModuleManager.CORRUPT_RESPONSE_STATUS_CODE = 8001;
 ...
 */
goog.loader.ModuleManager.prototype.setBatchModeEnabled = function(enabled) {
 ...
 * loads. The default {@see goog.loader.ModuleLoader} does not.
 * @param {boolean} enabled
 */
goog.loader.ModuleManager.prototype.setConcurrentLoadingEnabled = function(
    enabled) {
 ...
 */
goog.loader.ModuleManager.prototype.setAllModuleInfo = function(infoMap) {
  for (var id in infoMap) {
    this.moduleInfoMap_[id] = new goog.loader.ModuleInfo(infoMap[id], id);
  }
 ...
 */
goog.loader.ModuleManager.prototype.setAllModuleInfoString = function(
  ...
  for (var i = 0; i < modules.length; i++) {
    ...
    moduleIds.push(id);
    this.moduleInfoMap_[id] = new goog.loader.ModuleInfo(deps, id);
  }
 ...
 * @return {!goog.loader.ModuleInfo} The module info.
 */
goog.loader.ModuleManager.prototype.getModuleInfo = function(id) {
 ...
 */
goog.loader.ModuleManager.prototype.setModuleUris = function(moduleUriMap) {
 ...
 * @return {goog.loader.AbstractModuleLoader} An object that has a
 *     loadModules(ids, moduleInfoMap, opt_successFn, opt_errFn,
 *         opt_timeoutFn, opt_forceReload) method.
 */
goog.loader.ModuleManager.prototype.getLoader = function() {
  return this.loader_;
};
 ...
 * @param {goog.loader.AbstractModuleLoader} loader An object that has a
 *     loadModules(ids, moduleInfoMap, opt_successFn, opt_errFn,
 *         opt_timeoutFn, opt_forceReload) method.
 */
goog.loader.ModuleManager.prototype.setLoader = function(loader) {
  this.loader_ = loader;
};
 ...
 */
goog.loader.ModuleManager.prototype.getModuleContext = function() {
 ...
 */
goog.loader.ModuleManager.prototype.setModuleContext = function(context) {
 ...
 */
goog.loader.ModuleManager.prototype.isActive = function() {
 ...
 */
goog.loader.ModuleManager.prototype.isUserActive = function() {
 ...
 * @private
 */
goog.loader.ModuleManager.prototype.dispatchActiveIdleChangeIfNeeded_ =
    function() {
  var lastActive = this.lastActive_;
  var active = this.isActive();
  if (active != lastActive) {
    this.executeCallbacks_(
        active ? goog.loader.ModuleManager.CallbackType.ACTIVE :
                 goog.loader.ModuleManager.CallbackType.IDLE);
  ...
  if (userActive != userLastActive) {
    this.executeCallbacks_(
        userActive ? goog.loader.ModuleManager.CallbackType.USER_ACTIVE :
                     goog.loader.ModuleManager.CallbackType.USER_IDLE);
 ...
 */
goog.loader.ModuleManager.prototype.preloadModule = function(id, opt_timeout) {
 ...
 */
goog.loader.ModuleManager.prototype.prefetchModule = function(id) {
 ...
 * @private
 */
goog.loader.ModuleManager.prototype.addLoadModule_ = function(id, d) {
  var moduleInfo = this.getModuleInfo(id);
 ...
 * @private
 */
goog.loader.ModuleManager.prototype.loadModulesOrEnqueueIfNotLoadedOrLoading_ =
 ...
 * @param {!goog.loader.ModuleInfo} moduleInfo The module identifier for the
 *     given id.
 * @param {boolean} userInitiated If the load was user initiated.
 * @param {goog.async.Deferred} d A deferred object.
 * @private
 */
goog.loader.ModuleManager.prototype.registerModuleLoadCallbacks_ = function(
 ...
 * @private
 */
goog.loader.ModuleManager.prototype.loadModulesOrEnqueue_ = function(ids) {
 ...
 * @private
 */
goog.loader.ModuleManager.prototype.getBackOff_ = function() {
 ...
 * @private
 */
goog.loader.ModuleManager.prototype.loadModules_ = function(
 ...
 * @private
 */
goog.loader.ModuleManager.prototype.processModulesForLoad_ = function(ids) {
 ...
 * @private
 */
goog.loader.ModuleManager.prototype.getNotYetLoadedTransitiveDepIds_ = function(
    id) {
 ...
 * @private
 */
goog.loader.ModuleManager.prototype.maybeFinishBaseLoad_ = function() {
 ...
 */
goog.loader.ModuleManager.prototype.setLoaded = function(id) {
  if (this.isDisposed()) {
    goog.log.warning(
 ...
 */
goog.loader.ModuleManager.prototype.isModuleLoading = function(id) {
 ...
 * @return {!goog.loader.ModuleLoadCallback} A callback wrapper that exposes
 *     an abort and execute method.
 */
goog.loader.ModuleManager.prototype.execOnLoad = function(
  ...
  if (moduleInfo.isLoaded()) {
    ...
    // cases.
    callbackWrapper = new goog.loader.ModuleLoadCallback(fn, opt_handler);
 ...
 * @return {goog.async.Deferred} A deferred object.
 */
goog.loader.ModuleManager.prototype.load = function(
 ...
 *     id is finished.
 */
goog.loader.ModuleManager.prototype.loadMultiple = function(
 ...
 * @private
 */
goog.loader.ModuleManager.prototype.addUserInitiatedLoadingModule_ = function(
    id) {
 ...
 * @param {string} id Identifier of the module.
 */
goog.loader.ModuleManager.prototype.beforeLoadModuleCode = function(id) {
  this.loadTracer_ =
 ...
 * @param {string} id Identifier of the module.
 */
goog.loader.ModuleManager.prototype.afterLoadModuleCode = function(id) {
  if (!this.currentlyLoadingModule_ ||
 ...
 *     the callback.
 */
goog.loader.ModuleManager.prototype.registerInitializationCallback = function(
    fn, opt_handler) {
  if (!this.currentlyLoadingModule_) {
 ...
 *     the callback.
 */
goog.loader.ModuleManager.prototype.registerLateInitializationCallback =
 ...
 * {@see goog.loader.BaseModule}.
 * @param {Function} fn The constructor function.
 */
goog.loader.ModuleManager.prototype.setModuleConstructor = function(fn) {
  if (!this.currentlyLoadingModule_) {
    goog.log.error(this.logger_, 'No module is currently loading');
    return;
  }
 ...
 * @enum {number}
 */
goog.loader.ModuleManager.FailureType = {
  /** 401 Status. */
  UNAUTHORIZED: 0,
 ...
 * @private
 */
goog.loader.ModuleManager.prototype.handleLoadError_ = function(
  ...
  if (status == 401) {
    ...
    this.requeueBatchOrDispatchFailure_(
        goog.loader.ModuleManager.FailureType.OLD_CODE_GONE);
    this.loadNextModules_();
    ...
    this.requeueBatchOrDispatchFailure_(
        goog.loader.ModuleManager.FailureType.CONSECUTIVE_FAILURES);
    this.loadNextModules_();
  } else {
    goog.log.info(
        this.logger_,
    ...
    var forceReload =
        status == goog.loader.ModuleManager.CORRUPT_RESPONSE_STATUS_CODE;
 ...
 * @private
 */
goog.loader.ModuleManager.prototype.handleLoadTimeout_ = function() {
  goog.log.info(
      this.logger_, 'Aborting after timeout: ' + this.loadingModuleIds_);
  this.requeueBatchOrDispatchFailure_(
      goog.loader.ModuleManager.FailureType.TIMEOUT);
  this.loadNextModules_();
};
 ...
 * cause.
 * @param {goog.loader.ModuleManager.FailureType} cause The reason for the
 *     failure.
 * @private
 */
goog.loader.ModuleManager.prototype.requeueBatchOrDispatchFailure_ = function(
    cause) {
 ...
 * @private
 */
goog.loader.ModuleManager.prototype.dispatchModuleLoadFailed_ = function(
    cause) {
  ...
  var errorCallbacks =
      this.callbackMap_[goog.loader.ModuleManager.CallbackType.ERROR];
  if (errorCallbacks) {
    for (var i = 0; i < errorCallbacks.length; i++) {
      var callback = errorCallbacks[i];
      for (var j = 0; j < idsToCancel.length; j++) {
        callback(
            goog.loader.ModuleManager.CallbackType.ERROR, idsToCancel[j],
            cause);
      }
    }
  }
 ...
 * @private
 */
goog.loader.ModuleManager.prototype.loadNextModules_ = function() {
 ...
 * @param
 * {goog.loader.ModuleManager.CallbackType|Array<goog.loader.ModuleManager.CallbackType>}
 * types
 *  The callback type.
 * @param {Function} fn The function to register as a callback.
 */
goog.loader.ModuleManager.prototype.registerCallback = function(types, fn) {
 ...
 * @param {goog.loader.ModuleManager.CallbackType} type The callback type.
 * @param {Function} fn The callback function.
 * @private
 */
goog.loader.ModuleManager.prototype.registerCallback_ = function(type, fn) {
 ...
 * @private
 */
goog.loader.ModuleManager.prototype.executeCallbacks_ = function(type) {
...
/** @override */
goog.loader.ModuleManager.prototype.disposeInternal = function() {
  goog.loader.ModuleManager.base(this, 'disposeInternal');
