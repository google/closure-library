...
goog.provide('goog.loader.Loader');
 ...
 * the goog.loader.Loader instance.
 *
 * @constructor
 * @final
 */
goog.loader.Loader = function() {
  /**
...
goog.addSingletonGetter(goog.loader.Loader);


/**
 * Wrapper of goog.loader.Loader.require() for use in modules.
 * See method goog.loader.Loader.require() for
 ...
 */
goog.loader.Loader.require = function(module, symbol, callback) {
  goog.loader.Loader.getInstance().require(module, symbol, callback);
};


/**
 * Wrapper of goog.loader.Loader.provide() for use in modules
 * See method goog.loader.Loader.provide() for explanation of params.
 *
 ...
 */
goog.loader.Loader.provide = function(module, opt_symbol, opt_object) {
  goog.loader.Loader.getInstance().provide(module, opt_symbol, opt_object);
};


/**
 * Wrapper of init() so that we only need to export this single
 * identifier instead of three. See method goog.loader.Loader.init() for
 ...
 *     load.
 */
goog.loader.Loader.init = function(urlBase, opt_urlFunction) {
  goog.loader.Loader.getInstance().init(urlBase, opt_urlFunction);
};
 ...
 */
goog.loader.Loader.loaderCall = function(module, symbol) {
  return function() {
    var args = arguments;
    goog.loader.Loader.require(
 ...
 * @private
 */
goog.loader.Loader.prototype.getModuleUrl_ = function(urlBase, module) {
 ...
 * @type {string}
 */
goog.loader.Loader.LOAD_CALLBACK = '__gjsload__';
 ...
 * @private
 */
goog.loader.Loader.loaderEval_ = function(t_) {
  eval(t_);
};
 ...
 *     load.
 */
goog.loader.Loader.prototype.init = function(baseUrl, opt_urlFunction) {
  ...
  goog.exportSymbol(
      goog.loader.Loader.LOAD_CALLBACK, goog.loader.Loader.loaderEval_);
 ...
 *     resolved symbol as the argument once the module is loaded.
 */
goog.loader.Loader.prototype.require = function(module, symbol, callback) {
 ...
 *     all symbols of the module are defined.
 */
goog.loader.Loader.prototype.provide = function(
 ...
 * @private
 */
goog.loader.Loader.prototype.load_ = function(module) {
