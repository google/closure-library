...
// TODO(agrieve): Remove this @define once native compiler support is added.
/**
 * @define {boolean} When true, all tweaks-related code will be stripped.
 */
goog.tweak.STRIP_TWEAKS = !goog.DEBUG;


// TODO(agrieve): There is a bug in the compiler that causes these class
//     definitions to not be stripped without this outer if block.
