...
goog.structs.Map.prototype.equals = function(otherMap, opt_equalityFn) {
  ...
  for (var key in this.map_) {
    key = goog.structs.Map.getKey_(key);
...
goog.structs.Map.prototype.transpose = function() {
  ...
  for (var key in this.map_) {
    transposed.set(this.map_[key], goog.structs.Map.getKey_(key));
  }
  return transposed;
};
...
goog.structs.Map.prototype.toObject = function() {
  var res = {};
  for (var key in this.map_) {
    res[goog.structs.Map.getKey_(key)] = this.map_[key];
  }
  return res;
};
...
goog.structs.Map.isKey_ = function(s) {
  return s.charAt(0) == goog.structs.Map.keyPrefix_;
};
...
goog.structs.Map.makeKey_ = function(s) {
  return goog.structs.Map.keyPrefix_ + s;
};
