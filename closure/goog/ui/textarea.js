...
goog.ui.Textarea.prototype.getValue = function() {
  ...
  // We know it's safe to return the value if we know we had
  // user input or if we used the placeholder.
  if (this.supportsNativePlaceholder_() || this.hasUserInput_) {
