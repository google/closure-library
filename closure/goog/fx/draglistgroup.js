...
goog.fx.DragListGroup.prototype.handlePotentialDragStart_ = function(e) {
  ...
  this.eventHandler_.listen(this.dragger_, goog.fx.Dragger.EventType.START,
      this.handleDragStart_);
  this.eventHandler_.listen(this.dragger_,
      [goog.fx.Dragger.EventType.END, goog.fx.Dragger.EventType.CLEANUP],
      this.handleDragEnd_);
...
goog.fx.DragListGroup.prototype.handleDragEnd_ = function(dragEvent) {
  if (dragEvent.type == goog.fx.Dragger.EventType.END) {
    var rv = this.dispatchEvent(
        new goog.fx.DragListGroupEvent(
