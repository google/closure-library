 ...
 *
 * TODO(joeltine): There are several uses of nullable parameters in this class
 * that will cause exceptiosn if someone actually passes null. Make these
 * non-nullable.
 *
 ...
 *
 * Note, for the most part, any methods referencing drag events initiated by
 * the mouse will work for events initiated via touch.
 *
...
goog.fx.DragDropItem.prototype.maybeStartDrag_ = function(event, element) {
  ...
  this.eventHandler_
      .listen(element, eventType.MOUSEMOVE, this.dragMoveHandler_, false)
