...
goog.vec.mat4f.setColumns = function(mat, vec0, vec1, vec2, vec3) {
  goog.vec.mat4f.setColumn(mat, 0, vec0);
  goog.vec.mat4f.setColumn(mat, 1, vec1);
  goog.vec.mat4f.setColumn(mat, 2, vec2);
  goog.vec.mat4f.setColumn(mat, 3, vec3);
  return mat;
};
...
goog.vec.mat4f.getColumns = function(mat, vec0, vec1, vec2, vec3) {
  goog.vec.mat4f.getColumn(mat, 0, vec0);
  goog.vec.mat4f.getColumn(mat, 1, vec1);
  goog.vec.mat4f.getColumn(mat, 2, vec2);
  goog.vec.mat4f.getColumn(mat, 3, vec3);
};
...
goog.vec.mat4f.setRows = function(mat, vec0, vec1, vec2, vec3) {
  goog.vec.mat4f.setRow(mat, 0, vec0);
  goog.vec.mat4f.setRow(mat, 1, vec1);
  goog.vec.mat4f.setRow(mat, 2, vec2);
  goog.vec.mat4f.setRow(mat, 3, vec3);
  return mat;
};
...
goog.vec.mat4f.getRows = function(mat, vec0, vec1, vec2, vec3) {
  goog.vec.mat4f.getRow(mat, 0, vec0);
  goog.vec.mat4f.getRow(mat, 1, vec1);
  goog.vec.mat4f.getRow(mat, 2, vec2);
  goog.vec.mat4f.getRow(mat, 3, vec3);
};
...
goog.vec.mat4f.makeTranslate = function(mat, x, y, z) {
  ...
  return goog.vec.mat4f.setColumnValues(mat, 3, x, y, z, 1);
};
...
goog.vec.mat4f.makeScale = function(mat, x, y, z) {
  goog.vec.mat4f.makeIdentity(mat);
  return goog.vec.mat4f.setDiagonalValues(mat, x, y, z, 1);
};
...
goog.vec.mat4f.makeRotate = function(mat, angle, ax, ay, az) {
  ...
  return goog.vec.mat4f.setFromValues(mat,
      ax * ax * d + c,
      ax * ay * d + az * s,
      ax * az * d - ay * s,
      0,
...
goog.vec.mat4f.makeRotateX = function(mat, angle) {
  var c = Math.cos(angle);
  var s = Math.sin(angle);
  return goog.vec.mat4f.setFromValues(
...
goog.vec.mat4f.translate = function(mat, x, y, z) {
  return goog.vec.mat4f.setColumnValues(
      mat, 3,
