 ...
 * @throws {Error} if browser doesn't support xpath.
 */
goog.dom.xml.selectSingleNode = function(node, path) {
  ...
  throw Error('This browser does not support xpath for the given node. If ' +
              'IE, ensure XML Document was created using ActiveXObject.');
};
