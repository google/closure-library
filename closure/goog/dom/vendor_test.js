...
var UserAgents = goog.userAgentTestUtil.UserAgents;
...
function assertUserAgent(expectedAgents, uaString, opt_product, opt_vendor) {
  ...
  for (var ua in UserAgents) {
    ...
    var detected = goog.userAgentTestUtil.getUserAgentDetected(UserAgents[ua]);
    assertEquals(isExpected, detected);
  }
}
