...
goog.html.safeUrlTestVectors.VECTORS = [
  ...
  {
    input: 'ftp://username@example.com',
    expected: 'ftp://username@example.com',
    safe: true
  },
  {
  ...
  {
    input: 'data:image/;base64,z=',
    expected: 'about:invalid#zClosurez',
    safe: false
  },
  {input: 'data:ximage/png', expected: 'about:invalid#zClosurez', safe: false},
  {
    input: 'data:ximage/png;base64,z=',
    expected: 'about:invalid#zClosurez',
    safe: false
  },
  {
    input: 'data:image/pngx;base64,z=',
    expected: 'about:invalid#zClosurez',
    safe: false
  },
  {
    input: 'data:audio/whatever;base64,z=',
    expected: 'about:invalid#zClosurez',
    safe: false
  },
  {
    input: 'data:audio/;base64,z=',
    expected: 'about:invalid#zClosurez',
    safe: false
  },
  {
    input: 'data:video/whatever;base64,z=',
    expected: 'about:invalid#zClosurez',
    safe: false
  },
  {
    input: 'data:video/;base64,z=',
    expected: 'about:invalid#zClosurez',
    safe: false
  },
  {
  ...
  {
    input: 'data:video/mp4;baze64,z=',
    expected: 'about:invalid#zClosurez',
    safe: false
  },
  {
    input: 'data:video/mp4;,z=',
    expected: 'about:invalid#zClosurez',
    safe: false
  },
  {
    input: 'data:text/html,sdfsdfsdfsfsdfs;base64,anything',
    expected: 'about:invalid#zClosurez',
    safe: false
  },
  {
    input: 'data:image/svg+xml;base64,abc',
    expected: 'about:invalid#zClosurez',
    safe: false
  },
  ...
  {
    input: 'callto:+1234567890',
    expected: 'about:invalid#zClosurez',
    safe: false
  },
  {
    input: 'wtai://wp/mc;+1234567890',
    expected: 'about:invalid#zClosurez',
    safe: false
  },
  {
    input: 'rtsp://example.org/',
    expected: 'about:invalid#zClosurez',
    safe: false
  },
  {
    input: 'market://details?id=app',
    expected: 'about:invalid#zClosurez',
    safe: false
  },
  {input: 'geo:37.7,42.0', expected: 'about:invalid#zClosurez', safe: false},
  {
    input: 'skype:chat?jid=foo',
    expected: 'about:invalid#zClosurez',
    safe: false
  },
  {
    input: 'whatsapp://send?text=Hello',
    expected: 'about:invalid#zClosurez',
    safe: false
  },
  ...
  {
    input: 'java\u0000script:evil();',
    expected: 'about:invalid#zClosurez',
    safe: false
  },
  {
    input: 'http://www.f\u0000\u0000.com',
    expected: 'http://www.f\u0000\u0000.com',
    safe: true
  },
  {
    input:
  ...
  {
    input: 'data:audio/ogg;base64,abc',
    expected: 'data:audio/ogg;base64,abc',
    safe: true
  },
  {
    input: 'data:video/mpeg;base64,abc',
    expected: 'data:video/mpeg;base64,abc',
    safe: true
  },
  {
    input: 'data:video/ogg;base64,z=',
    expected: 'data:video/ogg;base64,z=',
    safe: true
  },
  {
    input: 'data:video/mp4;base64,z=',
    expected: 'data:video/mp4;base64,z=',
    safe: true
  },
  {
