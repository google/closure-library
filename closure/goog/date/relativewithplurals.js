...
goog.date.relativeWithPlurals.formatTimeDelta_ =
  ...
  if (!future && unit == goog.date.relative.Unit.MINUTES) {
    ...
    return new goog.i18n.MessageFormat(MSG_MINUTES_AGO).
        format({'NUM': delta});
    ...
    return new goog.i18n.MessageFormat(MSG_IN_MINUTES).
        format({'NUM': delta});
    ...
    return new goog.i18n.MessageFormat(MSG_HOURS_AGO).
        format({'NUM': delta});
    ...
    return new goog.i18n.MessageFormat(MSG_IN_HOURS).
        format({'NUM': delta});
    ...
    return new goog.i18n.MessageFormat(MSG_DAYS_AGO).
        format({'NUM': delta});
    ...
    return new goog.i18n.MessageFormat(MSG_IN_DAYS).
        format({'NUM': delta});
