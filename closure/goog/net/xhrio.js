 ...
 * followed by a generic completed event. Then the abort, error, or success
 * event is fired as appropriate. Lastly, the ready event will fire to indicate
 * that the object may be used to make another request.
 *
