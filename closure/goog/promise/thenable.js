...
/** @suppress {extraRequire} used in complex type for the type reference. */
...
class Thenable {
   ...
   *
   * @param {?(function(this:THIS, TYPE): VALUE)=} onFulfilled A function that
   *     will be invoked with the fulfillment value if the Promise is fulfilled.
   * @param {?(function(this:THIS, *): *)=} onRejected A function that will be
   *     invoked with the rejection reason if the Promise is rejected.
   * @param {THIS=} context An optional context object that will be the
   *     execution context for the callbacks. By default, functions are executed
   *     with the default this.
   * @return {RESULT} A new Promise that will receive the result of the
   *     fulfillment or rejection callback.
   * @template VALUE
   * @template THIS
   *
   ...
   *  =:
   */
  then(onFulfilled = undefined, onRejected = undefined, context = undefined) {}
  ...
  /**
   * @param {?} object
   * @return {boolean} Whether a given instance implements `Thenable`. The
