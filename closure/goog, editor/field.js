...
goog.editor.Field.prototype.setHtml = function(
    addParas, html, opt_dontFireDelayedChange, opt_applyLorem) {alert('field.js line 2124: html = ' + html);
  if (this.isLoading()) {
...
alert('field.js line 2144: html = ' + html);
 ...
 * @private
 */
goog.editor.Field.prototype.setInnerHtml_ = function(html) {alert('field.js line 2182: html = ' + html);
  var field = this.getElement();
  if (field) {
    ...
    if (this.usesIframe() && goog.editor.BrowserFeature.MOVES_STYLE_TO_HEAD) {
      ...
      for (var i = heads.length - 1; i >= 1; --i) {alert('field.js line 2193: heads[' + i + '] = ' + heads[i]);
        heads[i].parentNode.removeChild(heads[i]);
      }
    }
  } else {alert('field.js line 2197: got here!');
