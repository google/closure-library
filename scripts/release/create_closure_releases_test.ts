 ...
 */
function stripIndentForReleaseBody(strings: TemplateStringsArray) {
...
function spyOnClients(
  ...
  spyOn(GitHubClient.prototype, 'getLatestRelease').and.returnValue(
...
describe('createClosureReleases', () => {
  ...
  it("doesn't write rollback or rolled back release notes", async () => {
    spyOnClients('00', [
      {hash: '00', pJsonVersion: '20201009.0.0', message: ''},
      {
        hash: '0123abc456',
      ...
      },
      {
        hash: '02',
        pJsonVersion: '20201009.0.0',
        message: 'Automated rollback of commit 0123abc.',
      },
      {hash: '03', pJsonVersion: '20201010.0.0', message: ''},
    ]);
    await createClosureReleases(FAKE_TOKEN);
