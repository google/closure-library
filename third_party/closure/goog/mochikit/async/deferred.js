...
/**
 * Tests whether the result of a callback is an error. May be overridden by
 * subclasses to handle Error objects that do not inherit from Error.
 * @param {*} res A result from the callback chain.
...
goog.async.Deferred.prototype.fire_ = function() {
  ...
  while (this.chain_.length && this.paused_ == 0) {
    ...
    var f = this.isError(res) ? errback : callback;
